...
export default function DayTile({ day, onClick, isUnlocked: unlocked }) {
  const baseClasses = "relative aspect-square rounded-lg shadow-md transition-all duration-300 flex flex-col items-center justify-center p-4";
